  ...
  return (
    <div>
      <footer className="footer p-10 bg-base-200 text-base-content grid md:grid-cols-1 lg:grid-cols-3 gap-5 py-16">
        <div>
          <img src={logopic} alt="" height="50%" width="50%" />
        ...
        <div>
          <header className="text-[#D81517] text-2xl font-semibold"> CONTACT US</header>
          <p className="text-[#333] text-xl font-semibold flex gap-2 items-center"> <BiSolidPhoneCall className="text-red-600"></BiSolidPhoneCall> 91111 11190</p>
          <p className="text-[#333] text-xl font-semibold flex gap-2 items-center"> <BiSolidPhoneCall className="text-red-600"></BiSolidPhoneCall> 91111 67890</p>
          <p className="text-[#333] text-xl font-medium flex gap-2 items-center"><BiSolidEnvelope className="text-red-600"></BiSolidEnvelope> signicar@gmail.com</p>
...
<a className="link link-hover">Press kit</a>*/}
        ...
        <div>
          ...
          {/* <p className="text-[#333] text-3xl font-semibold flex gap-2 items-center"> <BiSolidPhoneCall className="text-red-600"></BiSolidPhoneCall> 12345 67890</p> */}
...
<a className="link link-hover text-xl">Cookie policy</a>*/}
      ...
      <footer className="footer px-10 py-4 border-t bg-base-200 text-base-content border-base-300">
        <aside className="items-center grid-flow-col">
          <p>
          © Copyright 2025 Car Dealer Developed By Signikart
          </p>
        </aside>
